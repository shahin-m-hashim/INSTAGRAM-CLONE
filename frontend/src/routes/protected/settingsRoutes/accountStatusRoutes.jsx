...
const RemovedContentSettingsPage = lazy(() =>
  wait(300).then(() =>
    import("pages/settings/account_status/RemovedContentSettingsPage")
  )
);

const LoweredContentSettingsPage = lazy(() =>
  wait(300).then(() =>
    import("pages/settings/account_status/LoweredContentSettingsPage")
  )
);

const HiddenFeaturesSettingsPage = lazy(() =>
  wait(300).then(() =>
    import("pages/settings/account_status/HiddenFeaturesSettingsPage")
  )
);
