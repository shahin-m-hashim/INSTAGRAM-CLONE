...
const PhotosAndVideosPage = lazy(() =>
  wait(300).then(() => import("pages/activity/PhotosAndVideosPage"))
);

const ActivityPostsPage = lazy(() =>
  wait(300).then(() =>
    import("pages/activity/photos_and_videos/ActivityPostsPage")
  )
);

const ActivityReelsPage = lazy(() =>
  wait(300).then(() =>
    import("pages/activity/photos_and_videos/ActivityReelsPage")
  )
);

const ActivityHighlightsPage = lazy(() =>
  wait(300).then(() =>
    import("pages/activity/photos_and_videos/ActivityHighlightsPage")
  )
);
