    ...
    <div className="flex flex-col gap-10 p-4 max-w-[600px] my-4 md:my-14 size-full">
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xs text-[rgb(168,168,168)] ">
          This controls who can create reels or stories that include your videos
          or photos and download them as part of their content.{" "}
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xs text-[rgb(168,168,168)] ">
          When this is on, your public posts or profile can be shown outside of
          Instagram, including articles and blogs.{" "}
          <a className="text-white hover:underline">Learn more</a>
        </p>
      ...
      <div className="flex flex-col gap-3">
        <h1 className="font-semibold">Allow businesses to interact with you</h1>
        ...
        <div className="flex flex-col gap-2 px-4 py-5 rounded-2xl border border-[rgb(54,54,54,0.7)]">
          ...
          <div className="flex items-center justify-between">
            <p className="text-xs text-[rgb(168,168,168)] ">
              ...
              photos and videos in their shops across Meta Company Products when
              you tag accounts with shops or use hashtags related to shops in
              your posts.&nbsp;
              <a className="text-white hover:underline">Learn more</a>
            </p>
            <ToggleSwitch checked={true} />
